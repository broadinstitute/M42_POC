...
dbutils.widgets.text("variants", f"{schema}raw_variants_clustered{version}")
dbutils.widgets.text("alt_allele", f"{schema}alt_allele{version}")
dbutils.widgets.text("alt_allele_not_clustered", f"{schema}alt_allele{version}")
dbutils.widgets.text("alt_allele_condensed", f"{schema}alt_allele_condensed{version}")

dbutils.widgets.text("new_samples", f"{schema}new_samples{version}")
dbutils.widgets.text("new_samples_condensed", f"{schema}new_samples_condensed{version}")
...
# SQL: 
# SELECT location, ref, allele, array_agg(sample_id) as sample_ids FROM cmotters_m42.default.alt_allele_v2 
